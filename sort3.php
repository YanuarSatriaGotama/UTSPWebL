...
<section class="content">
    <h1 class="title">SORTING JAKET</h1>
            ...
            <?php
                if (isset($_POST["ascending"])) {
                    $select_sql1 = "SELECT * FROM jaket ORDER BY Harga ASC";
                    $result = mysqli_query($conn, $select_sql1);

                } else if (isset($_POST["descending"])) {
                    $select_sql2 = "SELECT * FROM jaket ORDER BY Harga DESC";
                    $result = mysqli_query($conn, $select_sql2);
                } else {
                    $select_sql3 = "SELECT *FROM jaket";
        ...
        <center><a href="index3.php"><button class="create"> Kembali </button></a></center>
    </section>

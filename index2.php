...
<body id="badan">
    ...
    <h1 class="title">DATA CELANA</h1>
    <center>
    <a href="create2.php"><button class="create">Tambah Data</button></a>
    <a href="delete_all2.php"><button class="delete_all" type="submit" name="hapus">HAPUS SEMUA</button></a>
    <a href="sort2.php"><button class="sorting" type="submit" name="logout">Sorting</button></a>
    ...
    <form action="" method="post">
        ...
        <a href="index2.php"><button class="refresh">Refresh</button></a>
    </form>
    </center>

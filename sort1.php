...
<h1 class="title">SORTING BAJU</h1>
        ...
        <?php
            if (isset($_POST["ascending"])) {
                $select_sql1 = "SELECT * FROM baju ORDER BY Harga ASC";
                $result = mysqli_query($conn, $select_sql1);

            } else if (isset($_POST["descending"])) {
                $select_sql2 = "SELECT * FROM baju ORDER BY Harga DESC";
                $result = mysqli_query($conn, $select_sql2);
            } else {
                $select_sql3 = "SELECT *FROM baju";
    ...
    <center><a href="index1.php"><button class="create"> Kembali </button></a></center>
</section>

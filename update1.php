...
$id = $_GET["id"];
$read_sql = "SELECT * FROM baju WHERE id = $id";
...
if (isset($_POST["submit"])) {
    ...
    $update_sql = "UPDATE baju SET barang = '$barang', stok='$stok', harga='$harga', restock = '$restock' WHERE id='$id'";
    ...
    if ($result) {
        ...
        echo "<script>
            ...
            document.location.href = 'update1.php';
        </script>";
    }
}
?>
...
<div class="kotak_login">
    <h1 class="title">Update Data Baju</h1>
    <form action="" method="post">
        <input type="hidden" name="id" value="<?= $baju["id"]; ?>">
        <label for="barang">Barang</label><br>
        <input type="text" class="form_update" name="barang" id="barang" value="<?= $baju["Barang"]; ?>"><br><br>
        <label for="stok">Stok</label><br>
        <input type="text" class="form_update" name="stok" id="stok" value="<?= $baju["Stok"]; ?>"><br><br>
        <label for="harga">Harga</label><br>
        <input type="number" class="form_update" name="harga" id="harga" value="<?= $baju["Harga"]; ?>"><br><br>
        <label for="restock">Restock date(YYYY-MM-DD): </label>
        <input type="text" class="form_update" name="restock" id="restock" value="<?= $baju["Restock"]; ?>"><br><br>
